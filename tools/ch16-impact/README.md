# Scholarly Impact Toolkit

**Topic:** Scholarly Impact
**Original source page:** https://www.hermanaguinis.com/impact.html
**Primary cited source:** Aguinis (2025), Research Methodology

## Description

Separate administrator and researcher/educator paths built on a four-dimension, four-stakeholder impact framework (theory/research, education, organizations, society), each with weighted recommendation modules, culminating in an exportable, printable Impact Plan.
